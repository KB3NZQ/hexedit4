...
//    std::vector<FILE_ADDRESS> search_found_;
	...
	int drag_bookmark_;         // Bookmark being draged (-1 if not dragging)
	...
	// The following are for the ruler handles or "adjusters" that can be dragged to change row size etc
