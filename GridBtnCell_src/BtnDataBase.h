...
public:
    ...
    virtual void SetData(int /* nRow */, int /* nCol */, LONGLONG lParam)     { m_64Param = lParam; }
...
#if _MSC_VER >= 1300
    virtual LPCWSTR  GetText(int /* nRow */, int /* nCol */) const
        { return (m_strText.IsEmpty())? L"" : m_strText; }
#else
    ...
    virtual LONGLONG   GetData(int /* nRow */, int /* nCol */) const       { return m_64Param;  }
...
protected:
    ...
    LONGLONG   m_64Param;      // 32-bit value to associate with item
