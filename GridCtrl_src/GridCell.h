...
public:
    ...
    virtual LONGLONG      GetData() const             { return m_64Param;  }
...
protected:
#if _MSC_VER >= 1300
	CStringW   m_strText;      // Store as Unicode text even in ANSI build
#else
    CString    m_strText;      // Cell text (or binary data if you wish...)
#endif
    LONGLONG     m_64Param;       // 64-bit value to associate with item
